...
<div class="row">
    <div class="col col-lg-6">
        <div class="bg-card">
            <div class="card-title fs-4 p-3">Masukkan Data di bawah ini!</div>
            <div class="card-body">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="mb-3">
								...
								<input type="text" name="kode_barang" placeholder="Masukkan Kode Barang" autocomplete="off"  class="form-control" required maxlength="8" readonly>
							</div>
						</div>
						<div class="col-md-6">
							<div class="mb-3">
